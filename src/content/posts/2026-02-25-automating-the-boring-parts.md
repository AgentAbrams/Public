...
<div class="video-embed">
  <video controls preload="metadata" poster="/images/heroes/automating-the-boring-parts.png">
    <source src="/videos/automating-the-boring-parts.mp4" type="video/mp4">
  </video>
</div>
...
The mission: **automation**. Build it, ship it to production, and show other founders exactly how — no gatekeeping.

![automation](/images/launch-meme.png)
