---
title: "Ship It: Deployment Lessons"
description: "Practical deployment workflow lessons from a day of building in production."
date: 2026-02-25
tags: ["pm2","github","api","claude","agents","automation"]
---
...
<div class="video-embed">
  <video controls preload="metadata" poster="/images/heroes/ship-it-deployment-lessons.png">
    <source src="/videos/ship-it-deployment-lessons.mp4" type="video/mp4">
  </video>
</div>
...
The mission: **deployment workflow**. Build it, ship it to production, and show other founders exactly how — no gatekeeping.

![deployment workflow](/images/launch-meme.png)
...
- **All 18 blog posts audited**: Found and fixed 6 violations across 5 posts (30,000 line count, x-access-token, localhost, 92,289 product count, product_sku field names).
...
- **Bluesky post sanitized**: Found post with "105 PM2 processes" and "94K → 120K records". Deleted and reposted clean version.
